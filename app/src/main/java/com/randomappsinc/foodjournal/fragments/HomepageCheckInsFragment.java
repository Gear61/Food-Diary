...
public class HomepageCheckInsFragment extends Fragment {

    public static HomepageCheckInsFragment newInstance() {
        HomepageCheckInsFragment fragment = new HomepageCheckInsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.homepage_check_ins, container, false);
        mUnbinder = ButterKnife.bind(this, rootView);

        mToolbar.setTitle(R.string.check_ins);

        mAddCheckIn.setImageDrawable(new IconDrawable(getActivity(), IoniconsIcons.ion_android_add).colorRes(R.color.white));

        mCheckInsAdapter = new CheckInsAdapter(getActivity(), mNoResults, null);
